...
local killsay_phrases = {
    ...
    ksay_russian = {
        ...
        "Используйте Zenith.lua, чтобы исправить все ваши проблемы с hvh"
    },

    ksay_english = {
        "what this fella doin??",
        "Use Zenith.lua to fix all your hvh problems",
        "dont be loser buy Zenith Prim",
...
local aa_f = {
    --tanki online
    aa_check                      = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "antiaim builder", false),
    conditionselection            = menu.add_selection("Zenith  ›  antiaim  ›  main", "condition", {"global", "standing", "moving", "air", "air-duck", "crouching", "slow walk"}),

    -- override global
    aa_overg_stand                = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[s]  override global", false),
    aa_overg_move                 = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[m]  override global", false),
    aa_overg_air                  = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[a]  override global", false),
    aa_overg_airduck              = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[a-d] override global", false),
    aa_overg_crouch               = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[c]  override global", false),
    aa_overg_slowwalk             = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[sw] override global", false),

    -- jitter type
    aa_jittertype_global          = menu.add_selection("Zenith  ›  antiaim  ›  main", "[g] jitter type ", {"center", "offset"}),
    aa_jittertype_stand           = menu.add_selection("Zenith  ›  antiaim  ›  main", "[s] jitter type ", {"center", "offset"}),
    aa_jittertype_move            = menu.add_selection("Zenith  ›  antiaim  ›  main", "[m] jitter type", {"center", "offset"}),
    aa_jittertype_air             = menu.add_selection("Zenith  ›  antiaim  ›  main", "[a] jitter type", {"center", "offset"}),
    aa_jittertype_airduck         = menu.add_selection("Zenith  ›  antiaim  ›  main", "[a-d] jitter type", {"center", "offset"}),
    aa_jittertype_crouch          = menu.add_selection("Zenith  ›  antiaim  ›  main", "[c] jitter type", {"center", "offset"}),
    aa_jittertype_slowwalk        = menu.add_selection("Zenith  ›  antiaim  ›  main", "[sw] jitter type", {"center", "offset"}),
    -- jitter add
    aa_jitter_global              = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] jitter add", -180, 180),
    aa_jitter_stand               = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] jitter add", -180, 180),
    aa_jitter_move                = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] jitter add", -180, 180),
    aa_jitter_air                 = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] jitter add", -180, 180),
    aa_jitter_crouch              = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] jitter add", -180, 180),
    aa_jitter_airduck             = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] jitter add", -180, 180),
    aa_jitter_slowwalk            = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] jitter add", -180, 180),
    --yaw left
    aa_yawlimleft_global          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] yaw limit left", -90, 90),
    aa_yawlimleft_stand           = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] yaw limit left", -90, 90),
    aa_yawlimleft_move            = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] yaw limit left", -90, 90),
    aa_yawlimleft_air             = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] yaw limit left", -90, 90),
    aa_yawlimleft_airduck         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] yaw limit left", -90, 90),
    aa_yawlimleft_crouch          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] yaw limit left", -90, 90),
    aa_yawlimleft_slowwalk        = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] yaw limit left", -90, 90),
    --yaw right
    aa_yawlimright_global          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] yaw limit right", -90, 90),
    aa_yawlimright_stand          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] yaw limit right", -90, 90),
    aa_yawlimright_move           = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] yaw limit right", -90, 90),
    aa_yawlimright_air            = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] yaw limit right", -90, 90),
    aa_yawlimright_airduck        = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] yaw limit right", -90, 90),
    aa_yawlimright_crouch         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] yaw limit right", -90, 90),
    aa_yawlimright_slowwalk       = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] yaw limit right", -90, 90),
    --yaw offset
    aa_offset_global               = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] yaw offset", -180, 180),
    aa_offset_stand               = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] yaw offset", -180, 180),
    aa_offset_move                = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] yaw offset", -180, 180),
    aa_offset_air                 = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] yaw offset", -180, 180),
    aa_offset_airduck             = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] yaw offset", -180, 180),
    aa_offset_crouch              = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] yaw loffset", -180, 180),
    aa_offset_slowwalk            = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] yaw offset", -180, 180),
    --fake left
    aa_fakelimleft_global          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] fake limit left", 0, 100),
    aa_fakelimleft_stand          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] fake limit left", 0, 100),
    aa_fakelimleft_move           = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] fake limit left", 0, 100),
    aa_fakelimleft_air            = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] fake limit left", 0, 100),
    aa_fakelimleft_airduck        = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] fake limit left", 0, 100),
    aa_fakelimleft_crouch         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] fake limit left", 0, 100),
    aa_fakelimleft_slowwalk       = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] fake limit left", 0, 100),
    --fake right
    aa_fakelimright_global         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] fake limit right", 0, 100),
    aa_fakelimright_stand         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] fake limit right", 0, 100),
    aa_fakelimright_move          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] fake limit right", 0, 100),
    aa_fakelimright_air           = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] fake limit right", 0, 100),
    aa_fakelimright_airduck       = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] fake limit right", 0, 100),
    aa_fakelimright_crouch        = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] fake limit right", 0, 100),
    aa_fakelimright_slowwalk      = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] fake limit right", 0, 100),
    --lean checks & modes
    aa_lean_check_global           = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[g] use body lean", false),
    aa_lean_mode_global            = menu.add_selection("Zenith  ›  antiaim  ›  main", "[g] body lean mode", {"static", "jitter"}),
    aa_lean_check_stand           = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[s] use body lean", false),
    aa_lean_mode_stand            = menu.add_selection("Zenith  ›  antiaim  ›  main", "[s] body lean mode", {"static", "jitter"}),
    aa_lean_check_move            = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[m] use body lean", false),
    aa_lean_mode_move             = menu.add_selection("Zenith  ›  antiaim  ›  main", "[m] body lean mode", {"static", "jitter"}),
    aa_lean_check_air             = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[a] use body lean", false),
    aa_lean_mode_air              = menu.add_selection("Zenith  ›  antiaim  ›  main", "[a] body lean mode", {"static", "jitter"}),
    aa_lean_check_airduck         = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[a-d] use body lean", false),
    aa_lean_mode_airduck          = menu.add_selection("Zenith  ›  antiaim  ›  main", "[a-d] body lean mode", {"static", "jitter"}),
    aa_lean_check_crouch          = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[c] use body lean", false),
    aa_lean_mode_crouch           = menu.add_selection("Zenith  ›  antiaim  ›  main", "[c] body lean mode", {"static", "jitter"}),
    aa_lean_check_slowwalk        = menu.add_checkbox("Zenith  ›  antiaim  ›  main", "[sw] use body lean", false),
    aa_lean_mode_slowwalk         = menu.add_selection("Zenith  ›  antiaim  ›  main", "[sw] body lean mode", {"static", "jitter"}),
    --lean left
    aa_leanlimleft_global          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] lean limit left", 0, 50),
    aa_leanlimleft_stand          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] lean limit left", 0, 50),
    aa_leanlimleft_move           = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] lean limit left", 0, 50),
    aa_leanlimleft_air            = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] lean limit left", 0, 50),
    aa_leanlimleft_airduck        = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] lean limit left", 0, 50),
    aa_leanlimleft_crouch         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] lean limit left", 0, 50),
    aa_leanlimleft_slowwalk       = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] lean limit left", 0, 50),
    --lean right
    aa_leanlimright_global         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[g] lean limit right", 0, 50),
    aa_leanlimright_stand         = menu.add_slider("Zenith  ›  antiaim  ›  main", "[s] lean limit right", 0, 50),
    aa_leanlimright_move          = menu.add_slider("Zenith  ›  antiaim  ›  main", "[m] lean limit right", 0, 50),
    aa_leanlimright_air           = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a] lean limit right", 0, 50),
    aa_leanlimright_airduck       = menu.add_slider("Zenith  ›  antiaim  ›  main", "[a-d] lean limit right", 0, 50),
    aa_leanlimright_crouch        = menu.add_slider("Zenith  ›  antiaim  ›  main", "[c] lean limit right", 0, 50),
    aa_leanlimright_slowwalk      = menu.add_slider("Zenith  ›  antiaim  ›  main", "[sw] lean limit right", 0, 50),
    aa_lean_switchside            = menu.add_text("Zenith  ›  antiaim  ›  main", "switch static Lean side"),
    --yaw randomise left
    aa_randomise_global_left_check = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[g] randomise left yaw side", false),
    aa_randomise_global_left1      = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 1", -20, 20),
    aa_randomise_global_left2      = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 2", -20, 20),
    aa_randomise_stand_left_check = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[s] randomise left yaw side", false),
    aa_randomise_stand_left1      = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 1", -20, 20),
    aa_randomise_stand_left2      = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 2", -20, 20),
    aa_randomise_move_left_check  = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[m] randomise left yaw side", false),    
    aa_randomise_move_left1       = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 1", -20, 20),
    aa_randomise_move_left2       = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 2", -20, 20),    
    aa_randomise_air_left_check   = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[a] randomise left yaw side", false),    
    aa_randomise_air_left1        = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 1", -20, 20),
    aa_randomise_air_left2        = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 2", -20, 20),    
    aa_randomise_airduck_left_check   = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise left yaw side", false),    
    aa_randomise_airduck_left1    = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 1", -20, 20),
    aa_randomise_airduck_left2    = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 2", -20, 20),
    aa_randomise_crouch_left_check   = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[c] randomise left yaw side", false),    
    aa_randomise_crouch_left1     = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 1", -20, 20),
    aa_randomise_crouch_left2     = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 2", -20, 20),    
    aa_randomise_slowwalk_left_check   = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[sw] randomise left yaw side", false),    
    aa_randomise_slowwalk_left1   = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 1", -20, 20),
    aa_randomise_slowwalk_left2   = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 2", -20, 20),    
    --yaw randomise right
    aa_randomise_global_right_check= menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[g] randomise right yaw side", false),
    aa_randomise_global_right1     = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 1", -20, 20),
    aa_randomise_global_right2     = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 2", -20, 20),
    aa_randomise_stand_right_check= menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[s] randomise right yaw side", false),
    aa_randomise_stand_right1     = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 1", -20, 20),
    aa_randomise_stand_right2     = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 2", -20, 20),
    aa_randomise_move_right_check = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[m] randomise right yaw side", false),    
    aa_randomise_move_right1      = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 1", -20, 20),
    aa_randomise_move_right2      = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 2", -20, 20),   
    aa_randomise_air_right_check  = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[a] randomise right yaw side", false),    
    aa_randomise_air_right1       = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 1", -20, 20),
    aa_randomise_air_right2       = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 2", -20, 20),    
    aa_randomise_airduck_right_check  = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise right yaw side", false),    
    aa_randomise_airduck_right1   = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 1", -20, 20),
    aa_randomise_airduck_right2   = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 2", -20, 20), 
    aa_randomise_crouch_right_check  = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[c] randomise right yaw side", false),    
    aa_randomise_crouch_right1    = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 1", -20, 20),
    aa_randomise_crouch_right2    = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 2", -20, 20),    
    aa_randomise_slowwalk_right_check  = menu.add_checkbox("Zenith  ›  antiaim  ›  main  ›  additional features", "[sw] randomise right yaw side", false),    
    aa_randomise_slowwalk_right1  = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 1", -20, 20),
    aa_randomise_slowwalk_right2  = menu.add_slider("Zenith  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 2", -20, 20),
    -- animbreaker
    aa_animbreaker_check          = menu.add_checkbox("Zenith  ›  antiaim  ›  other", "animation breakers", false),
    aa_animbreaker_main           = menu.add_multi_selection("Zenith  ›  antiaim  ›  other", "main", {"lean in air", "legs in air", "backward slide", "0 pitch on land", "static legs on slowwalk"}),
    aa_animbreaker_legs           = menu.add_selection("Zenith  ›  antiaim  ›  other", "legs in air", {"static", "walk"}),
    aa_animbreaker_other          = menu.add_multi_selection("Zenith  ›  antiaim  ›  other", "other", {"sus"}),
    -- onshot fl
    onshotfl_check                = menu.add_checkbox("Zenith  ›  antiaim  ›  other", "on shot fakelag", false),
    -- lc
    lc_check                      = menu.add_checkbox("Zenith  ›  antiaim  ›  other", "break lc in air", false),
    lc_weapons                    = menu.add_multi_selection("Zenith  ›  antiaim  ›  other", "weapons", {"scout", "auto", "awp", "pistols", "deagle", "revolver", "taser", "other"}),
    lc_state_check                = menu.add_checkbox("Zenith  ›  antiaim  ›  other", "in all states", false),
    -- anti zeus
    anti_zeus_check               = menu.add_checkbox("Zenith  ›  antiaim  ›  other", "anti zeus", false),
    anti_zeus_max_dist            = menu.add_slider("Zenith  ›  antiaim  ›  other", "distance", 10, 30),
    -- warmup
    warmup_check                  = menu.add_checkbox("Zenith  ›  antiaim  ›  other", "shitty preset on warmup", false),
}
aa_f.anti_zeus_max_dist:set(17)

local rage_f = {
    customdt_check                = menu.add_checkbox("Zenith  ›  ragebot  ›  main", "override doubletap", false),
    customdt_speed                = menu.add_slider("Zenith  ›  ragebot  ›  main", "speed", 10, 22),
    customdt_waning               = menu.add_text("Zenith  ›  ragebot  ›  main", "this dt speed may cause unregistered shots."),
    customdt_corrections          = menu.add_checkbox("Zenith  ›  ragebot  ›  main", "disable corrections", false),
    recharge_check                = menu.add_checkbox("Zenith  ›  ragebot  ›  main", "faster recharge", false),
    prediction_check              = menu.add_checkbox("Zenith  ›  ragebot  ›  main", "better prediction", false),
    prediction_warning            = menu.add_text("Zenith  ›  ragebot  ›  main", "recommended to use this feature only with force prediction."),
    early_check                   = menu.add_checkbox("Zenith  ›  ragebot  ›  main", "early autostop on autopeek", false),
    early_weapons                 = menu.add_multi_selection("Zenith  ›  ragebot  ›  main", "weapons", {"scout", "awp"}),
}
rage_f.customdt_speed:set(15)

local visual_f = {
    windows_combo                 = menu.add_multi_selection("Zenith  ›  visual  ›  main", "windows", {"watermark", "keybinds"}),
    windows_mode                  = menu.add_selection("Zenith  ›  visual  ›  main", "windows style", {"Zenith ui v1", "Zenith ui v2"}),
    watermark_custom_watername    = menu.add_selection("Zenith  ›  visual  ›  main", "watermark name", {"Zenith", "primordial", "primordial | Zenith", "custom"}),
    watermark_custom_custom       = menu.add_text_input("Zenith  ›  visual  ›  main", "name"),
    watermark_custom_showuid      = menu.add_checkbox("Zenith  ›  visual  ›  main", "show uid", false),
    indicators_check              = menu.add_checkbox("Zenith  ›  visual  ›  main", "indicators", false),
    indicators_customisation      = menu.add_multi_selection("Zenith  ›  visual  ›  main", "customisation", {"doubletap charge bar", "background", "state color", "display desync side"}),
    indicators_customisation_bg   = menu.add_multi_selection("Zenith  ›  visual  ›  main", "apply background on", {"watermark", "state", "binds"}),
    indicators_state_color        = menu.add_selection("Zenith  ›  visual  ›  main", "state color mode", {"default", "state based"}),
    indicators_customisation_rect = menu.add_checkbox("Zenith  ›  visual  ›  main", "background rect", false),
    disable_primomark             = menu.add_checkbox("Zenith  ›  visual  ›  main", "disable primordial watermark", false),

    lethal_indicator_check        = menu.add_checkbox("Zenith  ›  visual  ›  main", "lethal indicator", false),
    slowdownind_check             = menu.add_checkbox("Zenith  ›  visual  ›  main", "slowed down indicator", false),
    infobox_check                 = menu.add_checkbox("Zenith  ›  visual  ›  main", "info box", false),
    penisdot_check                = menu.add_checkbox("Zenith  ›  visual  ›  main", "better penetration dot", false),
    zeus_warning_check            = menu.add_checkbox("Zenith  ›  visual  ›  main", "zeus warning", false),
    lobby_waning                  = menu.add_text("Zenith  ›  visual  ›  main", "you are in lobby some visual features will not work."),

    floydmode_check               = menu.add_checkbox("Zenith  ›  visual  ›  other", "dark theme", false),

    color_theme_mode              = menu.add_selection("Zenith  ›  visual  ›  accent color", "accent color mode", {"custom", "sync with menu"}),
    color_theme_text              = menu.add_text("Zenith  ›  visual  ›  accent color", "accent color main"),
    color_theme_text_2            = menu.add_text("Zenith  ›  visual  ›  accent color", "accent color second"),
    color_theme_alpha             = menu.add_slider("Zenith  ›  visual  ›  accent color", "global alpha", 0, 255),

    fonttext                      = menu.add_text("Zenith  ›  visual  ›  font", "install this font for the visuals work properly -"),
    fontlink                      = menu.add_button("Zenith  ›  visual  ›  font", "copy link", function() clipboard_export("https://www.dafont.com/smallest-pixel-7.font") client.log_screen("copied!") engine.execute_cmd("play reggin.wav") end),
}
visual_f.color_theme_alpha:set(148)

local misc_f = {
    trashtalk_check               = menu.add_checkbox("Zenith  ›  miscellaneous  ›  main", "trashtalk", false),
    trashtalk_mode                = menu.add_selection("Zenith  ›  miscellaneous  ›  main", "trashtalk mode", {"russian", "english"}),
    tt_hs_check                   = menu.add_checkbox("Zenith  ›  miscellaneous  ›  main", "announce headshot", false),
    clantag_check                 = menu.add_checkbox("Zenith  ›  miscellaneous  ›  main", "clantag", false),
    clantag_mode                  = menu.add_selection("Zenith  ›  miscellaneous  ›  main", "clantag mode", {"Zenith", "Zenith Prim"}),
    gh_fix_check                  = menu.add_checkbox("Zenith  ›  miscellaneous  ›  main", "grenade helper fix", false),
    autobuy_check                 = menu.add_checkbox("Zenith  ›  miscellaneous  ›  main", "disable autobuy on pistol round", false),

    localserver_check             = menu.add_checkbox("Zenith  ›  miscellaneous  ›  local server", "enable", false),
    localserver_configure         = menu.add_button("Zenith  ›  miscellaneous  ›  local server", "configure", function() engine.execute_cmd("sv_cheats 1; mp_do_warmup_offine 1; mp_warmuptime 14881488; mp_warmup_pausetimer 1;  mp_warmup_start; sv_infinite_ammo 1; mp_limitteams 16; mp_autoteambalance 0; bot_kick; god; sv_airaccelerate 80; bot_stop 1") end),
    localserver_bottext           = menu.add_text("Zenith  ›  miscellaneous  ›  local server", "bots -"),
    localserver_botaddct          = menu.add_button("Zenith  ›  miscellaneous  ›  local server", "add ct", function() engine.execute_cmd("bot_add_ct;") end),
    localserver_botaddt           = menu.add_button("Zenith  ›  miscellaneous  ›  local server", "add t", function() engine.execute_cmd("bot_add_t;") end),
    localserver_botkick           = menu.add_button("Zenith  ›  miscellaneous  ›  local server", "kick", function() engine.execute_cmd("bot_kick;") end),
}

local binds = {
    aa_lean_switchside_bind       = aa_f.aa_lean_switchside:add_keybind("Zenith  ›  antiaim  ›  main", "switch static lean side"),
}
...
local infotab = {
    space132                      = menu.add_text("Zenith  ›  information  ›  main", ""),
    neforlogo                     = menu.add_text("Zenith  ›  information  ›  main", "||| Zenith.Lua"),
    space12                       = menu.add_text("Zenith  ›  information  ›  main", ""),
    neforbild                     = menu.add_text("Zenith  ›  information  ›  main", "build: "..build.. "."),
    neforver                      = menu.add_text("Zenith  ›  information  ›  main", "version: "..buildver.. "."),
    neforuser                     = menu.add_text("Zenith  ›  information  ›  main", "user: " ..user.name.. " [" ..user.uid.. "]."),
    neforcord                     = menu.add_text("Zenith  ›  information  ›  main", "join our discord server to stay up to date."),
    neforlog                      = menu.add_text("Zenith  ›  information  ›  main", "changelog and other info in discord."),
}
...
local unregtab = {
    ...
    contactscopy                  = menu.add_button("error", "discord (click to copy)", function() clipboard_export("aint got a discord") client.log_screen("copied!") end),
}

menu.set_group_column("Zenith", 1)
menu.set_group_column("Zenith  ›  ragebot  ›  main", 2)
menu.set_group_column("Zenith  ›  antiaim  ›  main", 2)
menu.set_group_column("Zenith  ›  antiaim  ›  main  ›  additional features", 2)
local function aa_sort() if not aa_f.aa_check:get() then menu.set_group_column("Zenith  ›  antiaim  ›  other", 2) else menu.set_group_column("Zenith  ›  antiaim  ›  other", 1) end end
menu.set_group_column("Zenith  ›  visual  ›  main", 2)
menu.set_group_column("Zenith  ›  visual  ›  other", 1)
menu.set_group_column("Zenith  ›  visual  ›  font", 1)
menu.set_group_column("Zenith  ›  visual  ›  accent color", 2)
menu.set_group_column("Zenith  ›  miscellaneous  ›  main", 2)
menu.set_group_column("Zenith  ›  miscellaneous  ›  other", 2)
menu.set_group_column("Zenith  ›  miscellaneous  ›  local server", 2)
menu.set_group_column("Zenith  ›  information  ›  main", 2)
...
configs.import = function(input)
    local protected = function()
        ...
        client.log_screen("[Zenith] config loaded")
        engine.execute_cmd("play aa_config.wav")
    end
    local status, message = pcall(protected)
    if not status then
        client.log_screen("[Zenith] failed to load config or not all items have changed")
...
configs.export = function()
	...
	client.log_screen("[Zenith] config exported")
    engine.execute_cmd("play aa_config.wav")
end
...
local function menuwater()
    if menu.is_open() then 
        ...
        if visual_f.color_theme_mode:get() == 2 then
            ...
            render.text(pixel, "Zenith ", vec2_t(menu.get_pos().x + 10, menu.get_pos().y - 16), refs.accentclr:get())
        else
            ...
            render.text(pixel, "Zenith ", vec2_t(menu.get_pos().x + 10, menu.get_pos().y - 16), colorpickers.color_theme:get())
        end

        render.text(pixel, ".lua ", vec2_t(render.get_text_size(pixel, "Zenith").x + menu.get_pos().x + 10, menu.get_pos().y - 16), color_t(200,200,200, 255))
        render.text(pixel, anal_string, vec2_t(render.get_text_size(pixel, "Zenith.lua ").x + menu.get_pos().x + 10, menu.get_pos().y - 16), color_t(255,255,255, 255))
    end
end
    ...
    if visual_f.indicators_check:get() then
        ...
        if visual_f.indicators_customisation:get(2) then
            if visual_f.indicators_customisation_bg:get(1) then
                render.rect_filled(vec2_t(screensize.x/2 + 6, screensize.y/2 + 11), vec2_t(render.get_text_size(pixel, "Zenith").x + 5, render.get_text_size(pixel, "Zenith").y - 3), (color_t(0,0,0, 188)))
                if visual_f.indicators_customisation_rect:get() then
                    if visual_f.color_theme_mode:get() == 1 then
                        render.rect_filled(vec2_t(screensize.x/2 + 4, screensize.y/2 + 11), vec2_t(2, render.get_text_size(pixel, "Zenith").y - 3), colorpickers.color_theme:get())
                    else
                        render.rect_filled(vec2_t(screensize.x/2 + 4, screensize.y/2 + 11), vec2_t(2, render.get_text_size(pixel, "Zenith").y - 3), refs.accentclr:get())
                    end
                end
            end
        end
        ...
        if visual_f.color_theme_mode:get() == 1 then
            if visual_f.indicators_customisation:get(4) then
                ...
                render.text(pixel, "Zenith", vec2_t(screensize.x/2 + 8, screensize.y/2 + 10), color_t(colorpickers.color_theme:get().r, colorpickers.color_theme:get().g, colorpickers.color_theme:get().b, 255))
            end
        else
            if visual_f.indicators_customisation:get(4) then
                ...
                render.text(pixel, "Zenith", vec2_t(screensize.x/2 + 8, screensize.y/2 + 10), color_t(refs.accentclr:get().r, refs.accentclr:get().g, refs.accentclr:get().b, 255))
            end
        end
...
local function watermarkcustom()
    if visual_f.windows_combo:get(1) then
        ...
        elseif visual_f.watermark_custom_watername:get() == 3 then
            wmname = "primordial | Zenith"
        elseif visual_f.watermark_custom_watername:get() == 4 then
            wmname = visual_f.watermark_custom_custom:get() == "" and "Zenith" or visual_f.watermark_custom_custom:get()
        end
...
local function infobox()
    ...
    if visual_f.infobox_check:get() then
        ...
        if visual_f.color_theme_mode:get() == 1 then
            ...
            render.text(pixel, "Zenith.lua", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> ").x, screensize.y/2.5 + 20), color_t(255, 255, 255, 255))
            render.text(pixel, "["..build.."]", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> Zenith.lua ").x, screensize.y/2.5 + 20), colorpickers.color_theme:get())
            ...
            render.text(pixel, "Zenith.lua", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> ").x, screensize.y/2.5 + 20), color_t(255, 255, 255, 255))
            render.text(pixel, "["..build.."]", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> Zenith.lua").x, screensize.y/2.5 + 20), refs.accentclr:get())
